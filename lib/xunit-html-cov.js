...
var configFileName = process.env.XUNIT_HTML_COV_CONFIG ? process.env.XUNIT_HTML_COV_CONFIG : "../config.json";
var config;
try {
    ...
    console.log(e);
    throw new Error("Cannot load config file " + configFileName + ".  Make sure the path is correct.  Current " +
                    "working directory is " + __dirname + ".");
}
